...
stats_fn_hr = 'profile/Profile_learn_model_LS_hr_dms'
...
stats_fn = 'profile/Profile_learn_model_IM_dms'
stats_fn_hr = 'profile/Profile_learn_model_IM_hr_dms'
cProfile.run('''learn_model.main(df_copy,lm='memsaver',iteration=50,initialize='Rand',burnin=0)''',stats_fn)
