...
sst learn_model -lm memsaver -i dms_1_formatted -o dms_1_MCMC
sst learn_model -lm memsaver -i dms_2_formatted -o dms_2_MCMC

#learn mpra models 
sst learn_model -lm memsaver -i CRE_100uM_ds_formatted -o CRE_100uM_ds_MCMC
sst learn_model -lm memsaver -i CRE_100uM_test_formatted -o CRE_100uM_test_MCMC
