...
class EvaluateModel:
    ...
    def __init__(self,
        ...
        self.out_df = self.dataset_df.copy()
        self.out_df.loc[:, seqcol] = self.out_df.loc[:, seqcol].str.slice(start, end)
        ...
        # Compute values
        self.out_df['val'] = mymodel.evaluate(self.out_df)

        # Validate dataframe and return
        self.dataset_with_values = qc.validate_dataset(self.out_df, fix=True)
        self.out_df = qc.validate_dataset(self.out_df, fix=True)
