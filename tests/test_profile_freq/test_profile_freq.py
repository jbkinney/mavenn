...
class Tests(unittest.TestCase):
        ...
        for file_name in library_files:
            ...
            if '_good' in file_name:
                try:
                    ...
                    out_file = 'profile_freq_total_%s.txt'%description
            ...
            # If bad, then profile_freq.main should raise TypeError
    ...
    def test_profile_freq_bincounts(self):
        ...
        for file_name in library_files:
            ...
            # If bad or library, then profile_freq.main should raise TypeError
            ...
            # If good, then profile_freq.main should produce a valid df
                ...
                try:
                    df = executable()
                    qc.validate_profile_freq(df)
                    out_file = 'profile_freq_bin_%s.txt'%description
                    io.write(df,out_file)
                    io.load_profile_freq(out_file)
                    print 'good,',
    ...
    def test_profile_freq_seqslicing(self):
        ...
        for file_name in library_files:
            ...
            if 'good' in file_name:
                try:
                    df = executable_good1()
                    io.write(df,'profile_freq_splice2-10_%s.txt'%description)
                    executable_good2()
                    executable_good3()
