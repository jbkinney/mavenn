...
stats_fn_hr = 'profile/Profile_learn_model_LS_hr'
cProfile.run('''learn_model.main(df_copy,'LS',start=37,end=71)''',stats_fn)
...
stats_fn = 'profile/Profile_learn_model_IM'
stats_fn_hr = 'profile/Profile_learn_model_IM_hr'
cProfile.run('''learn_model.main(df_copy,'memsaver',iteration=5,start=37,end=71,initialize='Rand',burnin=0)''',stats_fn)
